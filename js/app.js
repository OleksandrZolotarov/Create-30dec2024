(() => {
    ...
    function documentAction(e) {
        const targetElement = e.target;
        const cardsContainer = document.querySelector(".online-courses__cards");
        const loadMore = document.querySelector(".online-courses__load-more");
        if (targetElement.closest(".online-courses__load-more")) {
            const isOpen = cardsContainer.classList.toggle("online-courses__cards-open");
            if (isOpen) {
                ...
                cardsContainer.style.maxHeight = `${cardsContainer.scrollHeight}px`;
                setTimeout((() => {
                    cardsContainer.style.maxHeight = "1350px";
                }), 0);
    ...
    if (countdownElement) {
        ...
        if (!isNaN(targetDate.getTime())) {
            ...
            updateCountdown();
        } else console.error("Invalid target date provided in the data-target attribute.");
    } else console.warn("Countdown element not found in the DOM.");
